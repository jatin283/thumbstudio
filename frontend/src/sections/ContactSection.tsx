...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Contact" text2="Reach out to us" text3="Ready to start your channel? Let’s connect and design something exceptional together for your videos." />
