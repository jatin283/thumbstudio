...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use this generator?" text3="Create stunning thumbnails that get clicks, without hassle." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    ThumbStudio helps you design thumbnail faster by transforming your idea of video accordingly.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">ThumbStudio empowers you to design beautifully and scale effortlessly.</p>
